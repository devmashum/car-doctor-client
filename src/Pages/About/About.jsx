...
const About = () => {
    return (
        <div className="lg:flex justify-center items-center bg-base-100 p-5 mt-[30px] lg:mt-[80px]">
            ...
            <div className="card-body lg:w-1/2">
                ...
                <h2 className="card-title text-[#151515] lg:text-[45px] text-2xl leading-tight ">We are qualified & of experience in this field</h2>
